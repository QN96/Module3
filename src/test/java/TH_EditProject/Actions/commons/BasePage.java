package TH_EditProject.Actions.commons;
...
//    }
    ...
    public void selectColorFromList(WebDriver driver, String xpathExpression, String colorCode) {
        String colorListXPath = String.format(xpathExpression, colorCode);
        clickToElement(driver, colorListXPath);
    }
    ...
    public void sendKeyToElementEnter(WebDriver driver, String xpathExpression, String value){
        getElement(driver,xpathExpression).clear();
        getElement(driver, xpathExpression).sendKeys(value, Keys.ENTER);
    }
    ...
    public void selectTaskOption1(WebDriver driver, String optionXpath, String valueXpath){
        new Select(getElement(driver,optionXpath)).selectByVisibleText(valueXpath);
    }
    ...
    public void selectItemInCustomDropdown1(WebDriver driver, String xpathExpression, String xpathChild) {
        // Click on the main dropdown element to open the dropdown
        getElement(driver, xpathExpression).click();
        sleepInSecond(1);

        // Locate the specific dropdown item using the unique xpathChild
        WebElement desiredItem = new WebDriverWait(driver, Duration.ofSeconds(30))
                .until(ExpectedConditions.elementToBeClickable(By.xpath(xpathChild)));

        // Scroll the page so that the selected item is in view
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", desiredItem);
        sleepInSecond(1);
    ...
    public void ClickAndSendkeyToElement(WebDriver driver, String xpathExpression, String value) {
