package TH_Form.Actions.commons;
...
//                break;
    ...
    private WebDriver initChromeDriverExe(String appURL) {
        System.out.println("Launching Chrome browser...");
        System.setProperty("webdriver.chrome.driver",projectPath + "src/test/java/TH_Form/Resource/chromedriver");
        driver=new ChromeDriver();
        driver.manage().window().maximize();
        driver.get(appURL);
        driver.manage().timeouts().pageLoadTimeout(30, TimeUnit.SECONDS);
    ...
    private WebDriver initFirefoxDriverExe(String appURL) {
        System.out.println("Launching Firefox browser...");
        System.setProperty("webdriver.gecko.driver",projectPath + "src/test/java/TH_Form/Resource/geckodriver");
        driver=new FirefoxDriver();
        driver.manage().window().maximize();
        driver.get(appURL);
        driver.manage().timeouts().pageLoadTimeout(30, TimeUnit.SECONDS);
...
//        System.out.println("Launching Edge browser...");
//        System.setProperty("webdriver.edge.driver",projectPath + "src/test/java/TH_Form/Resources/msedgedriver.exe");
//        driver=new EdgeDriver();
//        driver.manage().window().maximize();
//        driver.get(appURL);
//        driver.manage().timeouts().pageLoadTimeout(30, TimeUnit.SECONDS);
